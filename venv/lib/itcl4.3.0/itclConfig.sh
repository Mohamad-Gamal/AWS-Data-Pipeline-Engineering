...
# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-L/workspaces/AWS-Data-Pipeline-Engineering/venv/lib/itcl4.3.0 -litcl4.3.0'
ITCL_LIB_SPEC='-L/workspaces/AWS-Data-Pipeline-Engineering/venv/lib/itcl4.3.0 -litcl4.3.0'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-L/workspaces/AWS-Data-Pipeline-Engineering/venv/lib/itcl4.3.0 -litclstub4.3.0'
ITCL_STUB_LIB_SPEC='-L/workspaces/AWS-Data-Pipeline-Engineering/venv/lib/itcl4.3.0 -litclstub4.3.0'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='/workspaces/AWS-Data-Pipeline-Engineering/venv/lib/itcl4.3.0/libitclstub4.3.0.a'
ITCL_STUB_LIB_PATH='/workspaces/AWS-Data-Pipeline-Engineering/venv/lib/itcl4.3.0/libitclstub4.3.0.a'
